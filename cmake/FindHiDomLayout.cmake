...
pkg_check_modules(HIDOMLAYOUT hidomlayout)

set(VERSION_OK TRUE)

if (HIDOMLAYOUT_VERSION)
    if (HIDOMLAYOUT_FIND_VERSION_EXACT)
        if (NOT("${HIDOMLAYOUT_FIND_VERSION}" VERSION_EQUAL "${HIDOMLAYOUT_VERSION}"))
            set(VERSION_OK FALSE)
        endif ()
    else ()
        if ("${HIDOMLAYOUT_VERSION}" VERSION_LESS "${HIDOMLAYOUT_FIND_VERSION}")
            set(VERSION_OK FALSE)
        endif ()
    endif ()
endif ()

if (NOT HIDOMLAYOUT_INCLUDE_DIRS)
    set(HIDOMLAYOUT_INCLUDE_DIRS ${HIDOMLAYOUT_INCLUDEDIR})
endif ()

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(HIDOMLAYOUT DEFAULT_MSG HIDOMLAYOUT_INCLUDE_DIRS HIDOMLAYOUT_LIBRARIES VERSION_OK)
